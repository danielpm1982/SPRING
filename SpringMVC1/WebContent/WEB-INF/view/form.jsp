...
<html>
	...
	<body>
		...
		<form method="get" action="formResult">
			<input type="text" class="text" name="name" title="type your name" placeholder="type your name" /><br>
			<input type="date" class="date" name="birthDate" title="type your birthDate" /><br>
