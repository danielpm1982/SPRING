...
<html>
	...
	<body>
		...
		<form action="newOrderFormResult" method="get">
			<input type="submit" value="START_NEW_ORDER" title="discard current order from session and start a New Order !"/>
		</form>
		<form:form action="orderFormResult" method="GET" modelAttribute="order">
			...
			<input type="submit" value="PROCESS_CURRENT_ORDER" title="save current order in session and process its transaction, saving it in the persistence system !" />
		</form:form>
